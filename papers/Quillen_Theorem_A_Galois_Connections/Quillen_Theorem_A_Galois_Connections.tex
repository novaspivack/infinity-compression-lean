...
for Galois connections between partial orders. For a Galois connection
...
yet define simplicial homotopy as a type. Companion work applies the same
fiber/section/obstruction architecture to group extension splitting and
embedding problems. All results are formalized in Lean~4 with Mathlib, with

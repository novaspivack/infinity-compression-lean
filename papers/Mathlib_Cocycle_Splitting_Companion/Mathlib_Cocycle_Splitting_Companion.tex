...
v4.29.0-rc6. This note is Mathlib-reviewer-facing API documentation, not a program
overview; see~\cite{SpivackSynthesis} for how the suite fits together.
\end{abstract}
...
\noindent\textbf{Included in this PR:}
\begin{itemize}[nosep]
...
program synthesis manuscript, 2026.

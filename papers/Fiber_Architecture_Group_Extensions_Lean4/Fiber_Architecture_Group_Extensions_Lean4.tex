...
(\lean{NonAbelianObstruction.lean}, \lean{SchurMultiplier.lean}), an adapter
module (\lean{MathlibAdapter.lean}), an embedding-problem module
(\lean{EmbeddingProblem.lean}), and a module for faithfully flat descent.
...
(\texttt{TowerEmbeddingProblem.lean}: \texttt{towerEmbeddingProblem} and
\texttt{towerEmbeddingProblem\_solvable\_iff\_trivial\_cocycle}) packaging normal

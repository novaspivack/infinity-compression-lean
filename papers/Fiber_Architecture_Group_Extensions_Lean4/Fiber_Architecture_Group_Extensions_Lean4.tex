...
the program map is~\cite{SpivackSynthesis}. All results are fully machine-checked with zero \lean{sorry}.
\end{abstract}
...
\paragraph{Scope.}
The formalization works at the abstract group-theoretic level. The bridge to
actual Galois extensions---connecting \lean{EmbeddingProblem} to Mathlib's
\lean{IntermediateField} and \lean{IsGalois}---is future work.

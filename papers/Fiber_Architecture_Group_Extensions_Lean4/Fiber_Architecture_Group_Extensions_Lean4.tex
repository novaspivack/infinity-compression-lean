...
first step toward the cohomological classification of extensions. Companion
work applies the same fiber architecture to Quillen's Theorem~A for Galois
connections. All results are fully machine-checked with zero \lean{sorry}.
\end{abstract}
...
This paper isolates the cohomological group-extension and embedding-problem
component of a broader fiber/section/obstruction architecture. Companion
work~\cite{SpivackQuillen} applies the same architecture to Quillen's Theorem~A
for Galois connections, demonstrating that the method reaches beyond extension
theory into combinatorial topology.
